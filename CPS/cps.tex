...
\DeclarePairedDelimiter{\halfCloseInt}{[}{)}
\DeclarePairedDelimiter{\halfOpenInt}{(}{]}
...
\newcommand{\opt}[1]{z\left( #1 \right)}
...
\newcommand{\Mat}[3]{\MM_{#1 \times #2}(#3)}
